<template>
    ...
    <a-table :dataSource="dailyTrainCarriages" :columns="columns" :pagination="pagination" @change="handleTableChange"
        :loading="loading">
...
const onChangeCode = (dailyTrainCarriage) => {
  let t = Tool.copy(dailyTrainCarriage)
  delete t.id
