<template>
    <p>
        <a-space>
            ...
            <train-select-view v-model:value="params.dailyTrainSeatCode" width="200px"></train-select-view>
            <a-button type="primary" @click="handleQuery()">查询</a-button>
            <!-- <a-button type="primary" @click="onAdd">新增</a-button> -->
        </a-space>
    </p>
    <a-table :dataSource="dailyTrainSeats" :columns="columns" :pagination="pagination" @change="handleTableChange"
        :loading="loading">
...
const handleQuery = (param) => {
    ...
    axios.get("/business/admin/daily-train-seat/query-list", {
        params: {
            page: param.page,
            size: param.size,
            dailyTrainSeatCode: params.value.dailyTrainSeatCode,
